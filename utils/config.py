...
"INDEX_1": "Пожалуйста, произнесите голосом или напишите текстовым сообщением ваш ответ на мой вопрос: У вас сегодня болела голова, и если ответ положительный, то принимали ли вы какие-либо медикаменты для купирования приступа головной боли и какие, если принимали?".
Примечание к INDEX_1: Допустимые варианты ответов: "Болела, принимал {название медикамента или медикаментов}", "Болела, не принимал", "Не болела".
"INDEX_2": "Пожалуйста, произнесите голосом или укажите, насколько интенсивной была головная боль?".
Примечание к INDEX_2: Допустимые варианты ответов: числа от 1 до 10.
"INDEX_3": "В какой области (областях) болела голова? Пользователь может указать несколько областей через пробел или запятую".
Примечание к INDEX_3: Допустимые варианты ответов, их может быть несколько сразу: висок, теменная область, бровь, глаз, верхняя челюсть, нижняя челюсть, лоб, затылок. Если ответ включает любые из этих вариантов, он считается валидным.
"INDEX_4": "С какой стороны: с одной или с двух сторон, справа или слева?".
"INDEX_5": "Какой был характер головной боли? Пользователь может указать несколько вариантов через пробел или запятую".
Примечание к INDEX_5: Допустимые варианты ответов: давящая, пульсирующая, сжимающая, ноющая, ощущение прострела в одну или несколько точек, режущая, тупая, пронизывающая, острая, жгучая.
