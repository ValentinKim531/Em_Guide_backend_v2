...
"INDEX_4": "В какой области (областях) болела голова? Пользователь может указать несколько областей через пробел или запятую".
...
"INDEX_6": "Какой был характер головной боли? Пользователь может указать несколько вариантов через пробел или запятую".
