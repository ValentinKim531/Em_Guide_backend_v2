...
Примечание к INDEX_5: Допустимые варианты ответов, их может быть один или несколько сразу: давящая, пульсирующая, сжимающая, ноющая, ощущение прострела в одну или несколько точек, режущая, тупая, пронизывающая, острая, жгучая.
